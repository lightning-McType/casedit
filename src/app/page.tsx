...
export default function Home() {
	return (
		<div className="bg-slate-50">
					...
					<div className="col-span-2 px-6 lg:px-0 lg:pt-4">
						<div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
							...
							<h1 className="relative w-fit tracking-tight text-balance mt-16 font-bold !leading-tight text-gray-900 text-5xl md:text-6xl lg:text-7xl">
								Your Image on a <span className="bg-green-600 px-2 text-white rounded-lg">Custom</span> Phone Case
							</h1>
							<p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
								Capture your favorite memories with yout own, <span className="font-semibold">one-of-one</span> phone case. CaseCobra allows you to protect your memories, not just your
								phone case.
							</p>
							...
							<ul className="mt-8 space-y-2 text-left font-medium flex flex-col items-center sm:items-start">
								<div className="space-y-2">
									<li className="flex gap-1.5 items-center text-left">
										{' '}
										<Check className="h-5 w-5 shrink-0 text-green-600" /> High quality, durable material
									</li>
									<li className="flex gap-1.5 items-center text-left">
										{' '}
							...
							<div className="mt-12 flex flex-col sm:flex-row items-center sm:items-center gap-5">
								<div className="flex -space-x-4">
									...
									<Image
										...
										alt="user image"
										className="object-cover inline-block w-10 h-10 rounded-full ring-2 ring-slate-100"
										width={50}
										height={50}
									/>
								</div>
				...
				<MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
					...
					<div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
						<div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
							...
							<div className="text-lg leading-8">
								<p>
									...
									<span className="p-0.5 bg-slate-800 text-white">the image is super clear</span>, on the case I had before, the image started fading into yellow-ish color after a
						...
						<div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
							...
							<div className="text-lg leading-8">
								<p>
									&quot;I usually keep my phone together with my keys in my pocket and that led to some pretty heavy scratch marks on all of my last phone cases. This one, besides a
									barely noticeable scratch on the corner, <span className="p-0.5 bg-slate-800 text-white">looks brand new after about half a year</span>. I dig it.&quot;
								</p>
							</div>
			...
			{/* prompt to upload your photo section */}
			<section>
				<MaxWidthWrapper className="py-24">
					...
					<ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
						...
						<li className="w-fit">
							<Check className="w-5 h-5 text-green-600 inline mr-1.5" />5 year print warranty
						</li>
