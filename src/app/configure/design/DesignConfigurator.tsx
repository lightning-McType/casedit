		...
		<div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
			<div
				...
				<div className="relative w-60 bg-opacity-50 pointer-events-none aspect-[896/1831]">
					...
					<div className={cn('absolute inset-0 left-[3px] right-[3px] top-px bottom-px rounded-[32px]', `bg-${options.color.tw}`)} />
				</div>
														...
														<span className="flex flex-col text-sm">
															...
															{option.desc ? (
																<Description
																	...
																	<span className="block sm:inline">{option.desc}</span>
																</Description>
															) : null}
														</span>
													</span>
